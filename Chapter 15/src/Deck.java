...
public class Deck {
	...
	/*
	 * Returns index of the first location where card appears in deck. Or -1 if it
	 * does not appear. Uses a linear search.
	 */
	...
	/*
	 * Returns index of a location where card appears in deck. Or -1 if it does not
	 * appear. Uses a bisection search.
	 *
	...
	/*
	 * Chooses a random integer between low and high, including low, not including
	 * high.
	 */
	...
	/*
	 * Makes a new deck of cards with a subset of cards from the original. The old
	 * deck and new deck share references to the same card objects.
	 */
